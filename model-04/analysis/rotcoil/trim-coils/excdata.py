...
q14_60A_fnames = [
    'main_60A/up1MULTIPOLES-0A.txt',
    'main_60A/up1MULTIPOLES-2A.txt',
    'main_60A/up1MULTIPOLES-4A.txt',
    'main_60A/up1MULTIPOLES-6A.txt',
    'main_60A/up1MULTIPOLES-8A.txt',
    'main_60A/up1MULTIPOLES-10A.txt',
    'main_60A/downMULTIPOLES-8A.txt',
    'main_60A/downMULTIPOLES-6A.txt',
    'main_60A/downMULTIPOLES-4A.txt',
    'main_60A/downMULTIPOLES-2A.txt',
    'main_60A/downMULTIPOLES-0A.txt',
    'main_60A/downMULTIPOLES--2A.txt',
    'main_60A/downMULTIPOLES--4A.txt',
    'main_60A/downMULTIPOLES--6A.txt',
    'main_60A/downMULTIPOLES--8A.txt',
    'main_60A/downMULTIPOLES--10A.txt',
    'main_60A/up2MULTIPOLES--8A.txt',
    'main_60A/up2MULTIPOLES--6A.txt',
    'main_60A/up2MULTIPOLES--4A.txt',
    'main_60A/up2MULTIPOLES--2A.txt',
    'main_60A/up2MULTIPOLES-0A.txt',
    ]
...
def excdata_read(magnet):
    # print(magnet)
    if 'Q14_60A' in magnet:
        fnames = q14_60A_fnames
    elif 'Q14_80A' in magnet:
        fnames = q14_80A_fnames
    elif 'Q14_95A' in magnet:
        fnames = q14_95A_fnames
    elif 'Q14_110A' in magnet:
        fnames = q14_110A_fnames
    elif 'Q14_120A' in magnet:
        fnames = q14_120A_fnames
    elif 'Q14_140A' in magnet:
        fnames = q14_140A_fnames
...
def excdata_Q14_60A():
    ...
    plt.ylabel('GL [T]')
    plt.grid()
    plt.title('Q14 Trim Excitation Curve - 60A main coil')
    plt.show()
...
def excdata_Q14_80A():
    ...
    plt.ylabel('GL [T]')
    plt.grid()
    plt.title('Q14 Trim Excitation Curve - 80A main coil')
    plt.show()
...
def excdata_Q14_95A():
    ...
    plt.ylabel('GL [T]')
    plt.grid()
    plt.title('Q14 Trim Excitation Curve - 95A main coil')
    plt.show()

def excdata_Q14_110A():
    fam = 'Q14_110A'
    # exclude_harms = [0, ]
    exclude_harms = [ ]
    fnames = q14_110A_fnames
    label = 'si-quadrupole-q14-110A'
    main_harmonic = '1 normal'
    ...
    plt.ylabel('GL [T]')
    plt.grid()
    plt.title('Q14 Trim Excitation Curve - 110A main coil')
    plt.show()

def excdata_Q14_120A():
    fam = 'Q14_120A'
    # exclude_harms = [0, ]
    exclude_harms = [ ]
    fnames = q14_120A_fnames
    label = 'si-quadrupole-q14-120A'
    main_harmonic = '1 normal'
    ...
    plt.ylabel('GL [T]')
    plt.grid()
    plt.title('Q14 Trim Excitation Curve - 120A main coil')
    plt.show()

def excdata_Q14_140A():
    fam = 'Q14_140A'
    # exclude_harms = [0, ]
    exclude_harms = [ ]
    fnames = q14_140A_fnames
    label = 'si-quadrupole-q14-140A'
    main_harmonic = '1 normal'
    ...
    plt.ylabel('GL [T]')
    plt.grid()
    plt.title('Q14 Trim Excitation Curve - 140A main coil')
    plt.show()

def excdata_all_Q14(normalize):
    # exclude_harms = [0, ]
    exclude_harms = [ ]
    ...
    if normalize:
        ...
        ax.set_title('Q14 Trim Excitation Curves Normalized by Main Coil Current - Ramp Down')
    else:
        ax.set_ylabel(r'GL [T]')
        ax.set_title('Q14 Trim Excitation Curves - Ramp Down')
    ax.grid()
    ax.legend(bbox_to_anchor=(1.0, 1.0), frameon=True, fontsize=12)
    plt.tight_layout(True)
    plt.savefig('q14_trim_excdata_10A_to_m10A_rampdown.png', dpi=300)
    plt.show()
...
# excdata_Q14_120A()
# excdata_Q14_140A()
# excdata_all_Q14(normalize=False)
